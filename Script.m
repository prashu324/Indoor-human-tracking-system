...
%dataset = csvread('Datasets/straightLine_CalInertialAndMag.csv',1,0);
dataset = csvread('Datasets/stairsAndCorridor_CalInertialAndMag.csv',1,0);
%dataset = csvread('Datasets/spiralStairs_CalInertialAndMag.csv',1,0);
time = dataset(:,1);
gyrX= dataset(:,2);
gyrY = dataset(:,3);
gyrZ = dataset(:,4);
